...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { l_sensor_0 }]; IO_L24N_T3_RS0_15 Sch=l_sensor_0
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { r_sensor_0 }]; IO_L3N_T0_DQS_EMCCLK_14 Sch=r_sensor_0
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { u_sensor_0 }]; IO_L6N_T0_D08_VREF_14 Sch=u_sensor_0
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { d_sensor_0 }]; IO_L13N_T2_MRCC_14 Sch=d_sensor_0
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { EW_0 }]; IO_L18P_T2_A24_15 Sch=EW_0
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { NS_0 }]; IO_L24P_T3_RS1_15 Sch=NS_0
