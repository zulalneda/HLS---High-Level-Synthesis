...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { data_0[0] }]; IO_L24N_T3_RS0_15 Sch=data_0[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { data_0[1] }]; IO_L3N_T0_DQS_EMCCLK_14 Sch=data_0[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { data_0[2] }]; IO_L6N_T0_D08_VREF_14 Sch=data_0[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { data_0[3] }]; IO_L13N_T2_MRCC_14 Sch=data_0[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { data_0[4] }]; IO_L12N_T1_MRCC_14 Sch=data_0[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { data_0[5] }]; IO_L7N_T1_D10_14 Sch=data_0[5]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { data_0[6] }]; IO_L17N_T2_A13_D29_14 Sch=data_0[6]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { data_0[7] }]; IO_L5N_T0_D07_14 Sch=data_0[7]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { sw_0 }]; IO_L12P_T1_MRCC_14 Sch=sw_0
...
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_0 }]; IO_L16N_T2_A27_15 Sch=uart_tx_0
...
set_property -dict { PACKAGE_PIN B1    IOSTANDARD LVCMOS33 } [get_ports { uart_tx_0 }]; IO_L9P_T1_DQS_AD7P_35 Sch=uart_tx_0
